...
//		4. Possibly also implement distance sensor to determine the current state of the 
//		   Robot
//
//
public class AutonomousComplexDecisions extends Command {
	 ...
	 * @param targetNumber: Either 1 or 2, decides on the target goal to aim for
	 * 
	 */
    public AutonomousComplexDecisions(int startingPosition, String gameSpecificMessage, int targetNumber) {
